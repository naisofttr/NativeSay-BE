...
export class InitialMigration1737469628459 implements MigrationInterface {
    name = 'InitialMigration1737469628459'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."customers_membershiptype_enum" AS ENUM('FREE', 'PLUS', 'PRO')`);
        await queryRunner.query(`CREATE TABLE "customers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "name" character varying NOT NULL, "profilePhotoUrl" character varying, "refreshToken" character varying, "refreshTokenExpiryDate" TIMESTAMP, "membershipType" "public"."customers_membershiptype_enum" NOT NULL DEFAULT 'FREE', "createdAt" TIMESTAMP DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), CONSTRAINT "UQ_8536b8b85c06969f84f0c098b03" UNIQUE ("email"), CONSTRAINT "PK_133ec679a801fab5e070f73d3ea" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."customers_membershiptype_enum"`);
    }
